...
public class BoardController {
    ...
    @PutMapping("/gathering/{gatheringId}/board")
    public ResponseEntity<Object> updateBoard(@Username String username,
                                           @PathVariable Long gatheringId,
                                           @RequestPart AddBoardRequest addBoardRequest,
                                           @RequestPart("files") List<MultipartFile> files) throws IOException {
        UpdateBoardResponse updateBoardResponse = boardService.updateBoard(username,addBoardRequest,files,gatheringId);
