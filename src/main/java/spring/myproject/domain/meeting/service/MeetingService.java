...
public class MeetingService {
    ...
    public void addMeeting(AddMeetingRequest addMeetingRequest, String username) {
    ...
    public void deleteMeeting(AddMeetingRequest addMeetingRequest, String username, Long meetingId) {
    ...
    public MeetingResponse meetingDetail(Long meetingId, String username) {
        ...
        return MeetingResponse.builder()
                ...
                .createdBy(meeting.getCreatedBy().getUsername())
                .attendedBy(attendedBy(meetingId))
                .build();
    ...
    public Page<MeetingListResponse> meetings(int pageNum, String username,String title) {
        ...
        Page<Meeting> meetings = meetingRepository.meetings(pageRequest,title);
    ...
    private List<String> attendedBy(Long meetingId){
        List<User> attendsBy = meetingRepository.findAttendsBy(meetingId);
        return attendsBy.stream()
                .map(u -> u.getUsername())
